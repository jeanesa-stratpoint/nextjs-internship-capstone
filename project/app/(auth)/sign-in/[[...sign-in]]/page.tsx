...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl shadow-2xl rounded-3xl w-full max-w-[680px] p-4 sm:p-6 border border-transparent dark:border-zinc-800 transition-colors duration-300">
        ...
        <SignIn
          appearance={{
            elements: {
              ...
              alert:
                "bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 p-3 rounded-xl mb-4",
              alertText: "text-red-800 dark:text-red-400 text-sm font-medium",
              formButtonPrimary:
